...
class TestBORROWBOOKS(unittest.TestCase):
    ...
    def test_login_success(self):
        ...
        self.assertEqual(self.library.current_user, "123456")

    def test_login_fail_wrong_pin(self):
        # Test login failure with incorrect PIN
        self.assertFalse(self.library.login("123456", "0000"))
    ...
    def test_login_fail_nonexistent_user(self):
        ...
        self.assertFalse(self.library.login("999999", "1234"))
        self.assertIsNone(self.library.current_user)
    ...
    def test_borrow_book_success(self):
        ...
        self.assertIn("book1", self.library.user_data["123456"]["borrowed_books"])
    ...
    def test_borrow_book_fail_unavailable(self):
        ...
        self.assertNotIn("book1", self.library.user_data["654321"]["borrowed_books"])
    ...
    def test_return_book_success(self):
        ...
        self.assertTrue(result)
        self.assertNotIn("book1", self.library.user_data["123456"]["borrowed_books"])
    ...
    def test_borrow_book_multiple_users(self):
        ...
        self.assertTrue(result)
        self.assertIn("book2", self.library.user_data["654321"]["borrowed_books"])
